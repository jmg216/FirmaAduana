...
@XmlType(name = "Signature", namespace = "http://entities.wsv.isa.com/xsd", propOrder = {
    "cn",
    "fecha",
    "verify"
})
public class Signature {
    ...
    @XmlElementRef(name = "cn", namespace = "http://entities.wsv.isa.com/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<String> cn;
    @XmlElementRef(name = "fecha", namespace = "http://entities.wsv.isa.com/xsd", type = JAXBElement.class, required = false)
