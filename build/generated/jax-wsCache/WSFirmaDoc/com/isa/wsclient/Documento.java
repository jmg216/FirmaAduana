...
@XmlType(name = "Documento", namespace = "http://entities.isa.com/xsd", propOrder = {
    "documento",
    "ext",
    "id",
    "name",
...
public class Documento {
    ...
    @XmlElementRef(name = "documento", namespace = "http://entities.isa.com/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<byte[]> documento;
    @XmlElementRef(name = "ext", namespace = "http://entities.isa.com/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<String> ext;
    protected Long id;
    @XmlElementRef(name = "name", namespace = "http://entities.isa.com/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<String> name;
    @XmlElementRef(name = "tipo", namespace = "http://entities.isa.com/xsd", type = JAXBElement.class, required = false)
